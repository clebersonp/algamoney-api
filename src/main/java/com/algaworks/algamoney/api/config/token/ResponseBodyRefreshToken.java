...
@ControllerAdvice
public class ResponseBodyRefreshToken implements ResponseBodyAdvice<OAuth2AccessToken> {
	...
	private void adicionarRefreshTokenNoCookie(String refreshToken, HttpServletRequest request,
		...
		refreshTokenCookie.setSecure(false); // TODO quando for p producao deverar ser true
